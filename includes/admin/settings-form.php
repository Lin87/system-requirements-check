...
<p class="font-bold"><?php esc_html_e('Place the shortcode', 'system_requirements_check'); ?> <code>[system_requirements_check]</code> <?php esc_html_e('on a post or page to display the system requirements check results.', 'system_requirements_check'); ?></p>
